...
name: writer-prd
description: >
  Produces a structured Product Requirements Document (PRD) from a description of a product, feature, or initiative.
  Use this skill whenever the user mentions writing a PRD, product requirements, product brief, feature requirements,
...
A PRD bridges business intent and engineering execution. It must be specific enough to guide decisions but not prescribe implementation. The goal is to answer: _Why are we building this? For whom? What does success look like? What is and isn't in scope?_
...
| Goal                          | Metric                                | Target | Baseline            |
| ----------------------------- | ------------------------------------- | ------ | ------------------- |
| Reduce eye strain complaints  | Support tickets mentioning eye strain | -30%   | [assumed: 20/month] |
| Increase power-user retention | Monthly active users, >4h/day segment | +10%   | [assumed]           |
```
